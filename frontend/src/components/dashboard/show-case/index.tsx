...
function ShowCase({ is_heading, title, description, search }: Props) {
  ...
  function handleSubmit(event: FormEvent) {
    ...
    push(`/admin/fatwa-list?${params.toString()}`);
  }
        ...
        <div className={ShowCaseStyles.content}>
          {is_heading && (
            <>
              ...
              {title && (
                <h1
                  className={ShowCaseStyles.title}
                  style={{
                    marginTop: search ? "mt-[32px]" : "0px !important",
                  }}
                >
                  {title}
                </h1>
              ...
              {description && (
                <p className={ShowCaseStyles.description}>{description}</p>
              )}
            </>
          )}
          {search && (
