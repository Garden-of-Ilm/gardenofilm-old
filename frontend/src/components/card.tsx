...
export default function Card({
  ...
  return (
    <div
      onClick={onClick}
      className="flex cursor-pointer flex-col justify-between border border-slate-300/80 bg-white px-[18px] pt-[16px] shadow hover:border-slate-500 hover:shadow-md md:min-h-[150px] md:rounded-lg"
    >
