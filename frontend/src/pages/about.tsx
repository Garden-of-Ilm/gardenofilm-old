      ...
      <div className="mx-auto w-full max-w-7xl px-[32px] py-5 md:px-[72px]">
        <div className="">
          <p className="mb-2 leading-7">
            Garden of Ilm is a platform containing fatwas and benefits from the
            scholars of Islam. We follow the Qur&apos;an and the sunnah of
        ...
        <div className="mx-auto mt-8 w-full rounded bg-[#2F3E46] px-4 py-4 text-white md:w-3/5">
          ...
          <p className="my-3 border-l border-white pl-3 text-sm font-light">
            The best people are those of my generation, and then those who will
            come after them, and then those who will come after them.
          </p>
        ...
        <div className="mx-auto mt-8 w-full rounded bg-[#2F3E46] px-4 py-4 text-white md:w-3/5">
          <span className="mt-[24px] w-full text-center tracking-wide text-white">
            Ibn Sirin (<span className={rubik.className}>رحمه الله</span>) said,
          </span>
          <p className="my-3 border-l border-white pl-3 text-sm font-light">
            This knowledge is a religion, so consider from whom you receive your
            religion.
          </p>
          <p className="text-sm font-light text-[#b8c8d0ff]">
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="mt-3">
            <ul className="list-disc space-y-1 text-[15px]">
              ...
              <li className="ml-[25px] pl-1">Sheikh &apos;Ali Al-Tuwayjiri</li>
              <li className="ml-[25px] pl-1">
